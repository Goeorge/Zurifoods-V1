const restaurants = [
	{
		...
		cuisine_type: "Asian",
		menu: [
			{ categories: ["main", "sides", "salads", "drinks"] },
			{
				main: [
					{
						id: 1,
					...
					{
						id: 5,
						name: "kuku Kienyeji fry",
						price: "350.00",
						imgUrl: "/img/meals/meal-1.jpg",
					},
					{
						id: 6,
						name: "kuku Kienyeji stew",
						price: "350.00",
						imgUrl: "/img/meals/meal-1.jpg",
					},
					{
				...
				drinks: [
					{
						soda: [
							{ name: "small", price: "1.95", imgUrl: "/img/meals/meal-2.jpg" },
							{
								name: "medium",
								price: "2.20",
								imgUrl: "/img/meals/meal-2.jpg",
							},
							{ name: "large", price: "2.50", imgUrl: "/img/meals/meal-2.jpg" },
						],
						juice: [
							{
								name: "cocktail",
							...
							{ name: "mango", price: "2.50", imgUrl: "/img/meals/meal-2.jpg" },
							{
								name: "passion",
								price: "2.50",
								imgUrl: "/img/meals/meal-2.jpg",
						...
						water: { price: "1.25", imgUrl: "/img/meals/meal-2.jpg" },
					},
				],
			},
		],
	...
	},
	{
		...
		cuisine_type: "Pizza",
		menu: [
			{ categories: ["launch", "breakfast", "salads", "drinks"] },
			{
				launch: [
					{
						id: 1,
...
export function getRestaurant(id) {
	return restaurants.find((m) => m.id === id);
}
